...
public func replace<I : IndividualType>(factory:()->I)(pop:[I])->[I] {
    return (0..<pop.count).map { _ in return factory() }
}

public func identity<I : IndividualType>(pop:[I])->[I] {
    return pop
}

public func crossover<I : Crossoverable>(probability:Probability)(pop:[I])->[I] {
    var result = [I]()
...
public func mutation<I : Mutatable>(probability:Probability)(pop:[I])->[I] {
...
public func parallel<I : IndividualType>(batchSize str:UInt)(op: [I]->[I])(pop:[I])->[I] {
...
public func split<I : IndividualType>(#amount: Double, lhs: [I] -> [I], rhs: [I] -> [I])(pop:[I])->[I] {
